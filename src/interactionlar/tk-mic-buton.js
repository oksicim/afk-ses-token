const { toggleMikrofon } = require("../utils/selfbot-manager");
...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const parts = id.replace("tk_mic_secili_", "").split("_");
    ...
    for (const t of tokenler) {
      if (secilenIds.includes(t._id.toString())) toggleMikrofon(t.token);
    }
